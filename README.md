...
- **Storybook** — [#35528](https://github.com/storybookjs/storybook/pull/35528): root-caused a `TypeError` in the 10.5 focus instrumentation and proved (with a patched-bundle before/after) that it resolves **three** separate issues (#35503, #35502, #35546). **Merged** by a core maintainer; closed #35503 and #35502. See the [case study](./case-studies/storybook-focus-getter.md).
